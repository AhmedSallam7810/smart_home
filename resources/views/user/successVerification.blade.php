...
<div class="ui text container">
    <br><br>
    <div class="ui grid">
        <h1 class="ui dividing huge header centered column row"> Email Verified Successfully!</h1>
        <h2 class="ui center aligned icon header column row">
            <i class="circular hand peace icon"></i>
              Thanks
        </h2>
        <div class="ui row">
            <p class="ui center aligned column"> Congratulations! Your email address has been successfully verified.
                You can now enjoy all the features of our service. </p>
        </div>

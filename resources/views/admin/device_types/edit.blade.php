...
<section class="content">
    ...
    <div class="container-fluit m-3">
        <form class="card card-secondary" action="{{route('admin.device.types.update',$type->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
                    ...
                    <div class="card-body">
                        <div class="row d-flex ">
                            <div class="col-4">
                                ...
                                <input type="text"  name="en_name" value={{$type->en_name}} class="form-control" required>
                            </div>

                            <div class="col-4">

                                <label  >Arabic Name</label>
                                <input type="text" name="ar_name" value={{$type->ar_name}} class="form-control" required>
                            </div>

                            <div class="col-4">
                                <label >Icon Code</label>
                                <input type="text" name="icon" value={{$type->icon}} class="form-control" required>
                            </div>
